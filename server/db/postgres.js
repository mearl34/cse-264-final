...
export const addUser = async (gmail, gid, username, pfp, pronouns, is_private) => {
  const text = `
    INSERT INTO users (gmail, gid, username, pfp, pronouns, is_private)
    VALUES ($1, $2, $3, $4, $5, $6)
    RETURNING uid, gmail, gid, username, pfp, pronouns, is_private;
  `

  const values = [gmail, gid, username, pfp, pronouns, is_private]
